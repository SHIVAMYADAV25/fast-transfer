...
// // // ----------------------------------------------------------------------
// // // 2. HAND-DRAWN SKETCHY SVG ICONS
// // // ----------------------------------------------------------------------
...
// // const PhoneIcon = ({ className = "w-5 h-6" }: { className?: string }) => (
...
// // const HandArrow = ({ className = "w-4 h-4" }: { className?: string }) => (
...
// //   return (
// //     <div className={`inline-flex flex-col items-center select-none ${className}`} style={{ fontFamily, ...style }}>
// //       <button
// //         onClick={onClick}
...
// //         className="relative group cursor-pointer border-none bg-transparent p-0 outline-none focus:outline-none transition-transform duration-200 ease-out"
// //         style={{
// //           transform: isPressed
...
// //         <div
// //           className="relative px-3.5 py-2.5 min-w-[170px] sm:min-w-[190px] min-h-[62px] flex items-center justify-between gap-2.5 transition-colors duration-200 overflow-hidden"
// //           style={{
...
// //           <div className="flex-grow text-left leading-tight font-semibold text-base sm:text-lg tracking-wide whitespace-pre-line py-0.5">
// //             {title}
// //           </div>
...
// //       {subtext && (
// //         <span 
// //           className="mt-1 text-stone-800 text-sm tracking-wide opacity-90 transition-opacity duration-200"
// //           style={{ fontFamily }}
// //         >
// //           {subtext}
// //         </span>
...
// // // Custom Sketchy Icons matching the reference image
// // const KimoSparkles = () => (
// //   <svg className="w-5 h-5 text-stone-900" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
// //     <path d="M 4 8 L 12 4" />
// //     <path d="M 4 13 L 14 13" />
// //     <path d="M 4 18 L 12 21" />
// //   </svg>
// // );
...
// //           <a href="#x" className="p-0.5 hover:scale-105 transition-transform" aria-label="X">
// //             <SketchyXIcon />
// //           </a>
// //           <span className="text-stone-400 font-light text-base">|</span>
// //           <a href="#linkedin" className="p-0.5 hover:scale-105 transition-transform" aria-label="LinkedIn">
// //             <SketchyLinkedInIcon />
// //           </a>
// //         </nav>
// //       </header>

// //       {/* HERO MAIN SECTION (STAYS CENTERED) */}
// //       <main className="relative z-10 w-full max-w-[1200px] mx-auto flex flex-row items-center justify-between my-auto py-2 overflow-visible">
        
// //         {/* LEFT COLUMN: HERO TEXT & BUTTONS */}
// //         <div className="w-auto flex flex-col items-start gap-3 pl-2 shrink-0 z-10">
...
// //           {/* Action Buttons */}
// //           <div className="flex flex-row items-center justify-start gap-2.5 pt-2">
// //             <HandDrawnButton
...
// //         <div className="flex-1 h-full min-w-0 flex items-center justify-start overflow-visible pointer-events-none -ml-12 lg:-ml-20 z-0">
// //           <img 
...
// //       {/* 1. "Send from here" (Left side of phone) */}
// //       <div className="absolute top-[53%] left-[41%] xl:left-[45%] flex flex-col items-center select-none pointer-events-none z-30 -rotate-6">
...
// //           {/* Dashed curve bending down and right */}
...
// //       {/* 2. "Your files / Your devices / Your control" (Top Right) */}
// // <div className="absolute top-[18%] right-[6%] xl:right-[9%] flex flex-col items-start select-none pointer-events-none z-30 rotate-1">
...
// //     strokeLinecap="round"
// //   >
// //     {/* Single smooth curved underline */}
// //     <path d="M 4 8 Q 40 16 76 6" />
// //   </svg>
// // </div>

// //       {/* 3. "Receive anywhere" (Right of laptop) */}
// //       <div className="absolute top-[67%] right-[3%] xl:right-[8%] flex flex-col items-start select-none pointer-events-none z-30 -rotate-8">
...
// //           {/* Dashed curve bending down and left */}
...
//         {/* Inner Filled Container */}
//         <div
//           className="relative px-3.5 py-2.5 w-full lg:w-auto min-w-[170px] sm:min-w-[190px] min-h-[62px] flex items-center justify-between gap-2.5 transition-colors duration-200 overflow-hidden"
//           style={{
//             backgroundColor: bgColor,
//             color: textColor,
//             clipPath: 'polygon(2% 4%, 97% 2%, 99% 95%, 4% 98%)',
...
//           {/* Action Buttons */}
//           <div className="flex flex-col lg:flex-row items-center justify-start gap-3 lg:gap-2.5 pt-2 w-full lg:w-auto">
//             <HandDrawnButton
//               icon={<GlobeIcon className="w-5 h-5" />}
//               title="Use on Web"
//               subtext="Open in browser"
